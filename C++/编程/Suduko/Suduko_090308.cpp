...
int Clean(int Clean[][9][10])
{
	...
	for( Global_row = 0 ; Global_row < 9 ; Global_row++ )
	{
		for( Global_col = 0 ; Global_col < 9 ; Global_col++ )
		{
			if( Clean[Global_row][Global_col][0] != 0 )
			{
				//Clean
				{
				...
				// Fill by row
				{
					for( Global_k = 1 ; Global_k < 10 ; Global_k++ )
					{
						...
						if( Global_sum == 1 )
						{
							for( Global_j = 0 ; Global_j < 9 ; Global_j++ )
							{
								if( Fill[Global_row][Global_j][Global_k] == 1 && Fill[Global_row][Global_j][0] == 0 )
								{
				...
				// Fill by col
				{
					for( Global_k = 1 ; Global_k < 10 ; Global_k++ )
					{
						...
						if( Global_sum == 1 )
						{
							for( Global_i = 0 ; Global_i < 9 ; Global_i++ )
							{
								if( Fill[Global_i][Global_col][Global_k] == 1 && Fill[Global_i][Global_col][0] == 0 )
								{
					...
					for( Global_k = 1 ; Global_k < 10 ; Global_k++ )
					{
						...
						if( Global_sum == 1 )
						{
							for( Global_i = 0 ; Global_i < 3 ; Global_i++ )
							{
								for( Global_j = 0 ; Global_j < 3 ; Global_j++ )
								{
									if( Fill[ FillSqrRow + Global_i][ FillSqrCol + Global_j][ Global_k ] == 1 && Fill[ FillSqrRow + Global_i][ FillSqrCol + Global_j][ 0 ] == 0 )
									{
...
int main(int argc,int *argv[])
{
	...
	int main_i ;
	for( main_i = 0 ; main_i < 1000 ; main_i++ )
	{
		//Clean ( Global_Suduko );
		Fill( Global_Suduko );
	}
