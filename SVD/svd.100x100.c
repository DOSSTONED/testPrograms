/*
RESULT:
__WINDOWS 6x6 with float, 1000 matrixes:
Function svd() consumes 0.218000s.
The difference between a and a_bak is: 18024359.320355.

__WINDOWS 6x6 with double, 1000 matrixes:
Function svd() consumes 0.265000s.
The difference between a and a_bak is: 18024359.322100.

__WINDOWS 100x100 with double, 100 matrixes:
x86
Function svd() consumes 10.515000s.
The difference between a and a_bak is: 49989259.370299.
x64
Function svd() consumes 5.398000s.
The difference between a and a_bak is: 49989259.370299.

__WINDOWS 100x100 with float, 100 matrixes:
x86
Function svd() consumes 4.212000s.
The difference between a and a_bak is: 49990372.000000.
x64
Function svd() consumes 5.506000s.
The difference between a and a_bak is: 49990372.000000.
...
#define m 100
#define n 100
#define RepeatedTimes 100

FILE *file1 = NULL;
FILE *file2 = NULL;
float a[RepeatedTimes][m][n], a_bak[RepeatedTimes][m][n];
float diffBetween_a_a_bak = 0;
...
int main()
{
	...
	file1=fopen("Matrixe100x100.dat","r");
	if((file1)==NULL)
	{
	...
	diff = (float)(clock()-st)/CLOCKS_PER_SEC;
	// 0.023s in Windows
