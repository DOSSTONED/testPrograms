...
namespace SBarHook
{
    ...
    /*
    public delegate void DebugInfoHandler(string dbgInfo);
    public class Win32
    {
    ...
    public class InterfaceBase
    {
        ...
        {
            //removed debug info, cause there is no need to use these
            try
            {
    ...
    */
    ...
    public class SlideBar //: InterfaceBase
    {
        ...
        ~SlideBar()
        {
            ...
            this.StopAllEventWatcher(false);
        }
        ...
        /// </summary>
        /// <param name="disconnect">Whether disconnect the connection between program and device.</param>
        public void StopAllEventWatcher(bool disconnect)
        {
            try
            {
                if (disconnect)
