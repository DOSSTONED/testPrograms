...
namespace Slider_Test
{
    ...
    public class SlideBar
    {
        ...
        static internal bool isSelfAddMethod = false;
        static internal bool isSelfDelMethod = false;
        ...
        public event SlideBarEventHandler sbArriveEvent
        {
            ...
            add
            {
                if (!isSelfAddMethod)
                {
                    isSelfAddMethod = true;
                    this.sbArriveEvent += value;
                }
                else
                {
                    isSelfAddMethod = false;
                }
            }
            [MethodImpl(MethodImplOptions.Synchronized)]
            remove
            {
                if (!isSelfDelMethod)
                {
                    isSelfDelMethod = true;
                    this.sbArriveEvent -= value;
                }
                else
                {
                    isSelfDelMethod = false;
                }
            }
        }
        //public event SlideBarEventHandler sbArriveEvent_Parody
        //{
        //    [MethodImpl(MethodImplOptions.Synchronized)]
        //    add
        //    {
