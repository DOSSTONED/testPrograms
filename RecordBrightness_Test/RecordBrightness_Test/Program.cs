...
namespace RecordBrightness_Test
{
    static class Program
    {
        ...
        static void timer_Tick(object sender, EventArgs e)
        {
            ...
            if (curBri >= 0 && curBri < 256)
                写入Brightness((byte)curBri);//throw new NotImplementedException();
        }
        ...
        static string profilePath = Environment.CurrentDirectory + "\\DOSSTONED_Brightness.xml";
