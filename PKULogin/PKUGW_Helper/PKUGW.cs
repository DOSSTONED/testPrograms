...
namespace PKUGW
{
    public class PKUGW_WP
    {
        ...
        public static string paraCombination(string username, string password, string seperater, LoginType lt)
        {
        ...
        string _password;
        string _result;
        ManualResetEvent responseDone = new ManualResetEvent(false);
        ...
        /// <summary>
        /// 登陆主函数，用于登陆北大网关
        /// 由于手机为了保持界面响应，均采用异步处理，所以这个需要重新写。
        /// </summary>
        /// <param name="username">用户名</param>
        /// <param name="password">密码（明文）</param>
        /// <param name="lt">登陆类型</param>
        ...
        public string Login(string username, string password, LoginType lt)
        {
            ...
            //using (var requestStream = request.EndGetRequestStream())
            ...
            response.BeginGetResponse(new AsyncCallback(GetResponseCallback), request);
            responseDone.WaitOne();
        ...
        void GetRequestStreamCallback(IAsyncResult asynchronousResult)
        {
            ...
            byte[] byteArray = Encoding.UTF8.GetBytes(paraCombination(_username, _password, 莫名其妙的字符串, _lt));
        ...
        /// </summary>
        public static string 莫名其妙的字符串 = "|;kiDrqvfi7d$v0p5Fg72Vwbv2;|";//"%7C%3BkiDrqvfi7d%24v0p5Fg72Vwbv2%3B%7C";
